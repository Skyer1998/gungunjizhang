...
public class XykIndexDao {
    ...
    public  ArrayList<Integer> getUpateXyklist( LocalDate date){
        ArrayList<Integer> integers = new ArrayList<>();
        LocalDate date_old = date.minusMonths(1);
        String sql="SELECT list.card_number,bill_new.bill_day FROM bill_new,list WHERE list.card_number=bill_new " +
